...
(function () {
  ...
  s.textContent =
    ...
    + '#wup-mc.mc-on{bottom:calc(28px + env(safe-area-inset-bottom,0px))}'
    + '#wup-mc .mc-x{position:absolute;top:0;right:0;background:none;border:none;'
    + 'color:#475569;font-size:20px;cursor:pointer;line-height:1;border-radius:0 18px 0 8px;'
    + 'transition:color .15s;width:44px;height:44px;display:flex;align-items:center;'
    + 'justify-content:center;-webkit-tap-highlight-color:transparent}'
    + '@media(hover:hover){#wup-mc .mc-x:hover{color:#94a3b8;background:rgba(255,255,255,.06)}}'
    ...
    + '#wup-mc .mc-body{font-size:14px;color:#94a3b8;line-height:1.6;'
